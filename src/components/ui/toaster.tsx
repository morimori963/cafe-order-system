...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitive.Root
    ...
    className={cn(
      ...
      variant === "default" && "border bg-[var(--background)] text-[var(--foreground)]",
      variant === "destructive" &&
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-[var(--background)] transition-colors hover:bg-[var(--secondary)] focus:outline-none focus:ring-2 focus:ring-[var(--ring)] focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
      className
    )}
    {...props}
  />
